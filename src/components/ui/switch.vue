<template>
    <label class="switch switch-text switch-primary" :class="classes">
        <input :id="id" type="checkbox" class="switch-input" v-model="valueLocal">
        <span :data-on="labelOn" :data-off="labelOff" class="switch-label"></span>
