<template>
    <div class="pp-content">
        <div class="pp-inner-container">  
            <div class="pp_header">
                <h1>Privacy Policy of the <strong>Muso.AI</strong> Facebook app</h1>
            ...
            <div class="one_line_col">
              <h2 id="owner_of_the_data">
                Owner and Data Controller
                  ...
                  <p>MUSO.AI INC<br>11128 Weddington Street, 91205<br>North Hollywood, California</p>
                  <p><b>Owner contact email:</b> kyran@muso.ai</p>
            </div>
            <div class="one_line_col">
                <h2 id="types_of_data">
...
<style lang='scss' scoped>
    ...
    .pp-content h1, .pp-content h2, .pp-content h3 {
        color: #3F3F3F;
        margin: 0;
    }
    .pp-content h1+p, .pp-content h2+p, .pp-content h3+p {
        padding-top: 5px;
    }
    .pp-content h2  {
        font-size: 17px;
    ...
    .pp-inner-container .pp_header {
        border-bottom: 1px dotted #DFDFDF;
        padding-bottom: 25px;
        position: relative;
    }
    .pp-content .pp-inner-container .pp_header h1 {
        font-size: 19px;
        font-weight: normal;
        line-height: 23px;
        margin-bottom: 5px;
    }
    .pp-content .pp-inner-container .pp_header p {
        margin: 0;
        padding: 0;
    }
</style>