...
// Vue calls component "destroyed" lifecycle hook before transition ends.
// Sometimes it causes problems like content jumping. For example, when you remove DOM element inside "destroyed" hook.
export const transitionSafeDestroyed = Object.freeze({
  destroyed() {
    const vm = this;
